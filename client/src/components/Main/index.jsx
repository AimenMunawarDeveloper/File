  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        const response = await axios.get("https://mern-vercel-sigma.vercel.app/api/files/stats", {
          headers: {
    ...
    const fetchRecentFiles = async () => {
      try {
        ...
        const response = await axios.get("https://mern-vercel-sigma.vercel.app/api/files", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
