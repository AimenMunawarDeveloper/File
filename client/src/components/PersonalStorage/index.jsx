...
const PersonalStorage = () => {
  ...
  const fetchFiles = async () => {
    try {
      const { data } = await axios.get("https://mern-vercel-sigma.vercel.app/api/files", {
        headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post("https://mern-vercel-sigma.vercel.app/api/files", formData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://mern-vercel-sigma.vercel.app/api/files/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.put(
        `https://mern-vercel-sigma.vercel.app/api/files/${editingFile._id}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
